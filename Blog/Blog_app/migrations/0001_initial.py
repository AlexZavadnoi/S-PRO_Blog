    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_pictures', models.ManyToManyField(related_name='additional_picture_posts', to='Blog_app.image')),
            ],
            options={
                'ordering': ('-created_at',),
            },
        ...
        migrations.CreateModel(
            name='ImageView',
            fields=[
                ('image_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='Blog_app.image')),
            ],
            bases=('Blog_app.image',),
        ),
        migrations.CreateModel(
            name='Account',
            fields=[
        ...
        migrations.AddField(
            model_name='post',
            name='main_picture',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='main_picture_posts', to='Blog_app.image'),
        ),
        migrations.AddField(
            model_name='image',
            name='owner',
